...
import co.bxvip.skin.constant.SkinConfig;

import java.util.ArrayList;
import java.util.List;

import static co.bxvip.skin.utils.Ids.skin_tag_id;
...
public class SkinAttrSupport {
    ...
    public static SkinView getSkinView(View view) {
        Object tag = view.getTag(skin_tag_id);
        if (tag == null) {
            tag = view.getTag();
        }
