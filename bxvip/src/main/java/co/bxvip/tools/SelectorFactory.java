 ...
 *     author: vic
 *     time  : 18-3-28
 *     desc  : selector 背景构造器  https://github.com/chuwe1/SelectorDemo
 *
 *     background ：
 *          view.setBackground(SelectorFactory.newShapeSelector()
 *                .setDefaultStrokeColor(Color.GRAY)
 *                .setFocusedStrokeColor(Color.YELLOW)
 *               .setStrokeWidth(2)
 *               .create());
 *      color:
 *          view.setHintTextColor(SelectorFactory.newColorSelector()
