package co.bxvip.tools.zxing;

/**
 * @author Vic Zhou @link bxvipsky@gamil.com
 * @project: PHPKotlin com.eleven.vzzxinglibrary.VzZxingCodeUtil
 * @description:
 * @date 2017/10/20 13:23
 */
...
public class VzZxingCodeUtil {
     ...
     */
    public static boolean createZxingImage(String content, int widthPix,
...
//      pixels[y * widthPix + x] = ToolUI.getColor(R.color.main_red);
                    } else {
