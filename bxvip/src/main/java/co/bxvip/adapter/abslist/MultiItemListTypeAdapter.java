...
import co.bxvip.adapter.abslist.base.ItemViewDelegateManager;
...
public class MultiItemListTypeAdapter<T> extends BaseAdapter {
    ...
    public MultiItemListTypeAdapter(Context context, List<T> datas) {
        this.mContext = context;
        this.mDatas = datas;
        mItemViewDelegateManager = new ItemViewDelegateManager();
    }

    public MultiItemListTypeAdapter addItemViewDelegate(ItemViewDelegate<T> itemViewDelegate) {
