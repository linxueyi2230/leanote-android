package co.bxvip.android.commonlib.popwindow;
...
public class CustomPopWindow implements PopupWindow.OnDismissListener {
    ...
    private CustomPopWindow(Context context, Object o) {
    ...
    public CustomPopWindow showAsDropDown(View anchor, int xOff, int yOff) {
        if (this.mPopupWindow != null && !isShow()) {
    ...
    public static class PopupWindowBuilder {
        ...
        public PopupWindowBuilder resetView(View view){
            this.mCustomPopWindow.mContentView = null;
            this.mCustomPopWindow.mContentView = view;
            return this;
        }
